...
到这里Java层的Handler机制就讲完了，限于篇幅的原因和作者的水平，有些地方没有很深入的讲解，在此说声抱歉，但是大致的流程应该是有的，建议读者去仔细的读一下这块的源码，相信收获会不小。前面说了这只是Java层面的Handler消息机制，其实在Native层，也有一套C++的实现，有兴趣的小伙伴也可以看看这个的内容。
